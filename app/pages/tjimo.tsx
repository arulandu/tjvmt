...
const TjimoPage: NextPage<any> = () => {
    return (
        <Layout>
            <section className="h-screen flex items-center justify-center bg-no-repeat bg-center bg-opacity-75 bg-cover" style={{ backgroundImage: "url('images/tjbg_blur.jpg')" }}>
                <div>
                    <h1 className="m-auto mb-3 font-adam text-6xl text-white text-center">TJIMO</h1>
                    <p className="text-center text-2xl text-white">Spring, 2022 @ TJHSST</p>
            ...
            <section className="m-auto px-5 py-10 md:max-w-2/3 xl:max-w-1/2">
                ...
                <p className="mb-4 font-bold">
                    Registration opens on January 8<sup>th</sup>, 2022.
                </p>
            </section>
