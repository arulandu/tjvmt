...
const HeroSection = () => {
  return (
    <section id="hero" className='h-screen flex items-center justify-center'>
      <div className='m-4 sm:m-12 md:w-3/4 xl:w-1/2'>
        ...
        <div className='mt-2 relative w-full aspect-[18/5]'>
          <Image src='/images/nametag.png' layout='fill' objectFit='cover'/>
        </div>
...
const ExperienceCard = ({title, content, img}: {title: string, content: JSX.Element[], img: string}) => {
  return (
    <div className='w-96 xl:w-[36rem] mx-2 my-12 md:m-12 p-9 flex flex-col items-center border-4 border-white bg-navy bg-opacity-75'>
        ...
        content.map((item, ind) => {
          ...
          return (
            <div key={key} className='mt-6 flex justify-start'>
              ...
              <li className='text-white text-base xl:text-2xl'>{item}</li>
            </div>
          );
        })
      }
      ...
      {/* <div className='w-full flex items-start'> */}
        <div className='flex-grow'>
          <div className='relative aspect-[13/10]'>
            <Image src="/images/team.png" layout='fill' className=''/>
          </div>
        ...
        <div className='mt-16 xl:mt-0 ml-auto flex-grow flex flex-wrap items-center justify-around xl:justify-end'>
          {/* <h1 className='mb-4 w-full text-center text-white text-3xl font-bold'>Officers (2021-2022)</h1> */}
          {
            officers.map((officer) => {
              return (
                <div className='m-2 group flex justify-center'>
                  <div className='relative w-64 aspect-[3/2] '>
                    ...
                    <Image src={officer.picture} layout='fill' className='' />
                  </div>
                </div>
              );
            })
