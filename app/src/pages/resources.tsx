        ...
        <>
          <section className="flex flex-col items-center justify-center pt-24">
            ...
            <div className="flex justify-center flex-wrap">
              ...
              <Competition name="Purple Comet" date='April 2025' location='TJ' link='https://purplecomet.org/' text='Fun team competition which takes place before an ARML Practice. Allowed to use anything except for the internet :o.' selection='No TSTs! We will release a sign up form and all teams who sign up will be able take the contest.' withTJ={true} />
              <Competition name="SMT Online" date="Spring 2025" location="Home (Virtual)" link='https://www.stanfordmathtournament.com/' text='Open to anyone, make teams of 6-8, $15 per student.' selection='We will release a sign up form and register all teams who sign up to take the contest.' />
