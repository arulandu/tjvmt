        ...
        <>
          <section className="flex flex-col items-center justify-center pt-24">
            ...
            <div className="flex justify-center flex-wrap">
              ...
              <Competition name="ARML Power Spring" date='Spring 2025' location='TJ' link='' text='Unrelated to ARML, but we have two teams of 15 take the contest during 8th period or after school one day.' selection='Team selection using ARML rankings.' withTJ={true}/>
              <Competition name="SMT Online" date="Spring 2025" location="Home (Virtual)" link='https://www.stanfordmathtournament.com/' text='You can fly to Stanford if you want.' selection='This contest is self organized, so you can make your own team and register!' />
              <Competition name="JHMT" date='April 26, 2025' location="John Hopkins" link='https://math.jhu.edu/~mathclub/jhmt.html' text='Divisions are grades 9-10 and 11-12. Teams of 4.' selection='This contest is self organized, so you can make your own team and register!' />
