        ...
        <>
          <section className="flex flex-col items-center justify-center pt-24">
            ...
            <div className="flex justify-center flex-wrap">
              ...
              <Competition name="BMT Online" date="Dec 7, 2024" location="Home (Virtual)" link='https://berkeley.mt/events/bmt-2024-online/' text='Online version of BMT 2024 (must not have competed in a prior iteration of BMT 2024). Teams of 6.' selection='This contest is self organized, so you can make your own team and register (costs $8 per student)!' />
              ...
              <Competition name="Girls in Math at Yale" date="February 22, 2025" location="Yale" link='https://www.mmaths.org/girls-in-math-at-yale.html' text='Open to all girls.' selection='This contest is self organized, so you can make your own team and register!' />
              ...
              <Competition name="ARML Power Spring" date='March 5, 2025' location='TJ' link='' text='Unrelated to ARML, but we have two teams of 15 take the contest during 8th period or after school one day.' selection='Team selection using ARML rankings.' withTJ={true}/>
              <Competition name="CMIMC" date='March 15, 2025' location='CMU' link='https://cmimc.math.cmu.edu/' text='Chillest competiiton of the year. Last year we were able to take 8 teams of 6.' selection='Aside from A team, there are no TSTs! Choosing people based on club commitment.' withTJ={true} />
              <Competition name="Penn Math Contest" date='March 29, 2025' location='Home (Virtual) or UPenn' link='https://sites.google.com/view/pennmathcontest/home' text='Open to anyone, make teams of 3.' selection='This contest is self organized, so you can make your own team and register!'/>
              <Competition name="BrUMO" date='April 5, 2025' location="Brown" link='https://www.brumo.org/' text='Open to anyone, make teams of 4-6.' selection='This contest is self organized, so you can make your own team and register!' />
              <Competition name="SMT Online" date="April 13, 2025" location="Home (Virtual)" link='https://www.stanfordmathtournament.com/' text='Open to anyone, make teams of 6-8, $15 per student.' selection='We will release a sign up form and register all teams who sign up to take the contest.' />
              <Competition name="UVAMT" date='April 19, 2025' location='UVA' link='https://uvamt.vercel.app/' text='Open to anyone, make teams of 6.' selection='This contest is self organized, so you can make your own team and register!'/>
              <Competition name="Purple Comet" date='April 24, 2025' location='TJ' link='https://purplecomet.org/' text='Fun team competition which takes place before an ARML Practice. Allowed to use anything except for the internet :o.' selection='No TSTs! We will release a sign up form and all teams who sign up will be able take the contest.' withTJ={true} />
              <Competition name="JHMT" date='April 26, 2025' location="Johns Hopkins" link='https://math.jhu.edu/~mathclub/jhmt.html' text='Divisions are grades 9-10 and 11-12. Teams of 5.' selection='We will release a sign up form and register all teams who sign up to take the contest.' />
              ...
              <Competition name="ARML" date="May 31, 2025" location="Penn State" link="https://www.arml.com/" text="ARML is the last and biggest competition of the year! We usually take 3 teams of 15 plus a couple alternates." selection='TSTs taken every Thursday after school, starting around early February. Estimated 2 drops with the rest of the TSTs weighted equally.' withTJ={true}/>
            </div>
          </section>
          <br />
